...
# BBC NEWS
news_box = tk.Canvas(root, width=350, height=140, bg='#FF4500', highlightthickness=0).place(x=20, y=620)
...
for i in range(0, 7):
    ...
    tk.Label(news_box, text='- ' + headline[i], font='Montserrat 9', bg='#FF4500', fg='#FFFFFF').place(x=25, y=news_y)
    news_y += 19
...
weather_box_top = tk.Canvas(root, width=1265, height=20, bg='#008080', highlightthickness=0).place(x=20, y=80)
tk.Label(weather_box_top, text='Weather Forcast', font='Montserrat 7 bold', bg='#008080',
...
tk.Label(weather_box, text='Sunrise: ' + '05:30 ', font='Montserrat 12', bg='#2a475e',
         fg='#FFFFFF').place(x=1100, y=120)
tk.Label(weather_box, text='Sunset: ' + '19:21 ', font='Montserrat 12', bg='#2a475e',
         fg='#FFFFFF').place(x=1105, y=150)

#INSTAGRAM
def openWeb():
 webbrowser.open("http://instagram.com/chetan.singh18")  


random_box = tk.Canvas(root, width=350, height=140, bg='#2a475e', highlightthickness=0).place(x=20, y=240)
random_box_top = tk.Canvas(root, width=350, height=20, bg='#1b2838', highlightthickness=0).place(x=20, y=220)
open_web = tk.Button(random_box, width=10, height=5, text= 'Instagram', bg='#FFB6C1', command = openWeb).place(x=150, y=260)   
tk.Label(random_box_top, text='Contact me on Instagram', font='Montserrat 7 bold', bg='#1b2838', fg='#FFFFFF') \
    .place(x=25, y=220)

#MSRIT
def openSite():
 webbrowser.open("http://parents.msrit.edu/index.php")   


msrit_box = tk.Canvas(root, width=285, height=520, bg='#2a475e', highlightthickness=0).place(x=1000, y=240)
#background_image = ImageTk.PhotoImage(file=r'msrit.png')
#background_label = tk.Label(root, image=background_image)
#background_label.place(x=1000, y=240)
msrit_box_top = tk.Canvas(root, width=285, height=20, bg='#1b2838').place(x=1000, y=220)
open_site=tk.Button(msrit_box, width=40, height=5, text ='SIS', bg="#9932CC", command=openSite).place(x=1000, y=620)
tk.Label(msrit_box_top, text='MSRIT', font='Montserrat 7 bold', bg='#1b2838',
...
tk.Label(hdd_box, text=str(hdd_data[3][1]) + 'GB / ' + str(hdd_data[3][0]) + 'GB',
...
tk.Label(hdd_box, text=str(hdd_data[4][1]) + 'GB / ' + str(hdd_data[4][0]) + 'GB',
         font='Montserrat 8', bg='#2a475e',
